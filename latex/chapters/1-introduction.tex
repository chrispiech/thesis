...
\subsection{Testable Machine Learning}
...
\subref{fig:introProjects} Subjective measure of the degree to which different algorithms are able to understand students over the range of assignments that they apply. 
\subref{fig:introImpact} The big picture of our maximum ability to understand students and where we would like to go.
