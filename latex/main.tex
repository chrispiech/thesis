...
\input{chapters/2-deepKnowledgeTracing}

\chapter{Problem Solving Policies}
\input{chapters/3-problemSolvingPolicies}

\chapter{Homework Embedding Spaces}
\input{chapters/4-programEncoding}

\chapter{Shared Substructures}
\input{chapters/5-scalableHomeworkSearch}

\chapter{Crowd Source Feedback}
\input{chapters/6-peerGrading}
